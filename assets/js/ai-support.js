...
(function () {
  ...
  const HISTORY_KEY = 'kenne_group_ai_chat';
  const LEAD_KEY = 'kenne_group_ai_lead_logged';

  const KB = [
    { keys: ['phone', 'iphone', 'samsung', 'electronic', 'device', 'accessory', 'accessories', 'charger', 'earbud'],
      reply: "For mobile phones, electronics, and accessories, that's Kenne Smart Technology — genuine devices, tested and verified before sale.",
      cta: { label: '📱 Visit Kenne Tech', href: 'smart-tech/index.html' } },
    { keys: ['ship', 'shipping', 'cargo', 'track', 'tracking', 'import', 'export', 'sourcing', 'supplier', 'customs', 'money exchange', 'currency'],
      reply: "For China sourcing, importation, cargo, and money exchange, that's Kenne Cargo — fast, safe, reliable shipment from China to Cameroon.",
      cta: { label: '🚢 Visit Kenne Cargo', href: 'cargo/index.html' } },
    { keys: ['car', 'vehicle', 'rent a car', 'rental', 'toyota', 'wholesale car', 'auto part'],
      reply: "For buying, renting, or sourcing car parts, that's Kenne Car Business — wholesale &amp; retail vehicles, rentals, and genuine parts.",
      cta: { label: '🚗 Visit Kenne Cars', href: 'cars/index.html' } },
    { keys: ['divisions', 'businesses', 'what does kenne do', 'services', 'about'],
      reply: "KENNE operates across three divisions: Kenne Smart Technology (phones & electronics), Kenne Cargo (China sourcing & importation), and Kenne Car Business (vehicles, rentals & parts).",
      cta: { label: 'See Our Divisions', href: '#divisions' } },
    { keys: ['wholesale', 'bulk', 'reseller', 'dealer'],
      reply: "KENNE offers wholesale solutions across technology, automotive, and other product categories — tell us what you need and our team will guide you.",
      cta: { label: '💬 Chat on WhatsApp', whatsapp: true } },
    { keys: ['contact', 'phone number', 'call', 'human', 'agent', 'speak to someone', 'real person'],
    ...
    { keys: ['hi', 'hello', 'hey', 'good morning', 'good afternoon'],
      reply: "Hello! 👋 I'm the KENNE assistant. Ask me about phones, cargo/sourcing, or cars — or tap a quick option below." },
    { keys: ['thank', 'thanks'],
      reply: "You're very welcome! Connect. Source. Import. Drive. 😊 Anything else I can help with?" },
  ];
  ...
  function buildWidget() {
    ...
    wrap.innerHTML = `
      <div class="kc-ai-launcher" id="kc-ai-launcher">
        ...
        <button class="kc-ai-btn kc-ai-btn--main" id="kc-ai-toggle" aria-label="Open KENNE Assistant" title="Chat with the KENNE Assistant">
      ...
      <div class="kc-ai-panel" id="kc-ai-panel" hidden>
        ...
        <div class="kc-ai-quick" id="kc-ai-quick">
          <button type="button" data-q="Phones & electronics">Phones &amp; electronics</button>
          <button type="button" data-q="China sourcing & cargo">China sourcing &amp; cargo</button>
          <button type="button" data-q="Cars & rentals">Cars &amp; rentals</button>
  ...
  function wireWidget() {
    ...
    toggle.addEventListener('click', () => {
      ...
      if (willOpen && !document.getElementById('kc-ai-messages').children.length) {
        addBubble('bot', "Hi there! 👋 I'm the KENNE assistant. Ask me about phones, cargo/sourcing, or cars — or tap a quick option below.");
      }
    });
