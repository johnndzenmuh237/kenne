...
(function () {
  ...
  const HISTORY_KEY = 'kennecargo_ai_chat';
  const LEAD_KEY = 'kennecargo_ai_lead_logged';

  const KB = [
    { keys: ['track', 'tracking', 'where is my', 'status', 'shipment number'],
      reply: "You can track any shipment with your Kenne Cargo tracking number (looks like KC-2026-XXXXXX) on our Tracking page.",
      cta: { label: '🗺️ Go to Tracking', href: 'tracking.html' } },
    { keys: ['price', 'quote', 'cost', 'how much', 'rate', 'rates'],
      reply: "Pricing depends on the service, weight/volume, and route. The fastest way to get an exact number is to request a free quote — it takes about 2 minutes and you'll get a tracking number as soon as it's registered.",
      cta: { label: '💬 Get a Free Quote', href: 'quote-request.html' } },
    { keys: ['car', 'buy a car', 'vehicle', 'toyota', 'auto'],
      reply: "We buy all kinds of cars in China — new, used and auction vehicles — inspect them, handle the paperwork, and ship them safely to Cameroon.",
      cta: { label: 'Learn About Buying Cars', href: 'services.html#buy-cars' } },
    { keys: ['supplier', 'source', 'sourcing', 'factory', 'manufacturer'],
      reply: "We find trusted, verified suppliers in China matched to exactly what you need — then negotiate on your behalf before anything ships.",
      cta: { label: 'Learn About Sourcing', href: 'services.html#sourcing' } },
    { keys: ['door to door', 'delivery', 'deliver', 'warehouse'],
      reply: "We deliver from our warehouse in China straight to your door in Cameroon — no separate pickup, no extra running around.",
      cta: { label: 'Learn About Door to Door', href: 'services.html#door-to-door' } },
    { keys: ['customs', 'import', 'export', 'clearance', 'duties', 'tariff'],
      reply: "We handle all import and export procedures between China and Cameroon — documentation, duties, tariffs, and customs clearance included.",
      cta: { label: 'Learn About Import & Export', href: 'services.html#import-export' } },
    { keys: ['money', 'exchange', 'currency', 'cfa', 'rmb', 'yuan'],
      reply: "We offer secure, competitive currency exchange to support your purchases and shipments between China (RMB) and Cameroon (CFA).",
      cta: { label: 'Learn About Money Exchange', href: 'services.html#money-exchange' } },
    { keys: ['ship', 'shipping', 'ocean', 'air freight', 'sea freight', 'container'],
      reply: "We ship by ocean freight (~30–35 days) and air freight (3–5 days) from Guangzhou, China to Douala, Cameroon — every shipment gets a tracking number.",
      cta: { label: 'View Shipping Services', href: 'services.html#shipping' } },
    ...
    { keys: ['hi', 'hello', 'hey', 'good morning', 'good afternoon'],
      reply: "Hello! 👋 I'm the Kenne Cargo assistant. I can help with tracking, quotes, our services, or connect you to our team on WhatsApp. What do you need?" },
    { keys: ['thank', 'thanks'],
      reply: "You're very welcome! Let us handle it — you relax. 😊 Anything else I can help with?" },
  ];
  ...
  function buildWidget() {
    ...
    wrap.innerHTML = `
      <div class="kc-ai-launcher" id="kc-ai-launcher">
        ...
        <button class="kc-ai-btn kc-ai-btn--main" id="kc-ai-toggle" aria-label="Open Kenne Cargo Assistant" title="Chat with Kenne Cargo Assistant">
      ...
      <div class="kc-ai-panel" id="kc-ai-panel" hidden>
        <div class="kc-ai-header">
          ...
          <div class="kc-ai-header-text">
            <strong>Kenne Cargo Assistant</strong>
        ...
        <div class="kc-ai-quick" id="kc-ai-quick">
          <button type="button" data-q="Track my shipment">Track my shipment</button>
          <button type="button" data-q="Get a quote">Get a quote</button>
          <button type="button" data-q="We buy cars">We buy cars</button>
  ...
  function wireWidget() {
    ...
    toggle.addEventListener('click', () => {
      ...
      if (willOpen && !document.getElementById('kc-ai-messages').children.length) {
        addBubble('bot', "Hi there! 👋 I'm the Kenne Cargo Assistant. Ask me about tracking, quotes, buying cars, or any of our services — or tap a quick option below.");
      }
    });
