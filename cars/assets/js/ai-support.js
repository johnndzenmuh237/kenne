...
(function () {
  ...
  const HISTORY_KEY = 'kenne_cars_ai_chat';
  const LEAD_KEY = 'kenne_cars_ai_lead_logged';

  const KB = [
    { keys: ['track', 'tracking', 'where is my order', 'order status', 'order number'],
      reply: "Every order gets an order number the moment you check out. If you have yours, WhatsApp our team with the number and we'll give you a live update.",
      cta: { label: '💬 Chat on WhatsApp', whatsapp: true } },
    { keys: ['price', 'cost', 'how much', 'budget'],
      reply: "Prices vary by make, model, and year — browse our inventory to see live prices, or tell me your budget and I can point you toward a category.",
      cta: { label: '🚗 Browse Inventory', href: 'inventory.html' } },
    { keys: ['wholesale', 'bulk', 'dealer', 'reseller'],
      reply: "We offer wholesale lot pricing for dealers and resellers buying in bulk — check the Wholesale Lot section of our inventory or message us for volume discounts.",
      cta: { label: 'View Wholesale Lot', href: 'inventory.html?category=wholesale' } },
    { keys: ['rent', 'rental', 'hire a car', 'book a car'],
      reply: "We rent cars by the day — self-drive or with a driver, from city sedans to event SUVs and vans.",
      cta: { label: '🔑 View Rentals', href: 'rentals.html' } },
    { keys: ['part', 'parts', 'accessory', 'accessories', 'brake', 'battery', 'tire', 'tyre'],
      reply: "We stock genuine car parts and accessories — brakes, batteries, tires, interior and more.",
      cta: { label: '🛠️ Shop Parts', href: 'parts.html' } },
    ...
    { keys: ['cart', 'checkout', 'buy', 'purchase'],
      reply: "You can add any car or part to your cart and check out directly on the site — you'll get an order number instantly.",
      cta: { label: '🛒 View Cart', href: 'cart.html' } },
    ...
    { keys: ['hi', 'hello', 'hey', 'good morning', 'good afternoon'],
      reply: "Hello! 👋 I'm the Kenne Cars assistant. Ask me about buying, renting, or parts — or tap a quick option below." },
    { keys: ['thank', 'thanks'],
      reply: "You're very welcome! Drive away happy. 😊 Anything else I can help with?" },
  ];
  ...
  function buildWidget() {
    ...
    wrap.innerHTML = `
      <div class="kc-ai-launcher" id="kc-ai-launcher">
        ...
        <button class="kc-ai-btn kc-ai-btn--main" id="kc-ai-toggle" aria-label="Open Kenne Cars Assistant" title="Chat with Kenne Cars Assistant">
      ...
      <div class="kc-ai-panel" id="kc-ai-panel" hidden>
        <div class="kc-ai-header">
          ...
          <div class="kc-ai-header-text">
            <strong>Kenne Cars Assistant</strong>
        ...
        <div class="kc-ai-quick" id="kc-ai-quick">
          <button type="button" data-q="Browse cars">Browse cars</button>
          <button type="button" data-q="Rent a car">Rent a car</button>
          <button type="button" data-q="Shop parts">Shop parts</button>
  ...
  function wireWidget() {
    ...
    toggle.addEventListener('click', () => {
      ...
      if (willOpen && !document.getElementById('kc-ai-messages').children.length) {
        addBubble('bot', "Hi there! 👋 I'm the Kenne Cars Assistant. Ask me about buying, renting, or parts — or tap a quick option below.");
      }
    });
